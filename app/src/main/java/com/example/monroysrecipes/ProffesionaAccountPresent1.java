...
public class ProffesionaAccountPresent1 extends Fragment {

    FragmentProffesionaAccountPresent1Binding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentProffesionaAccountPresent1Binding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonNext1 = binding.buttonNext2;
        buttonBack = binding.btnBack;

        buttonNext1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_goPA2);
            }
        });
