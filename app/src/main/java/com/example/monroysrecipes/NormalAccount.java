...
import com.example.monroysrecipes.databinding.FragmentNormalAccountBinding;
import com.example.monroysrecipes.databinding.FragmentProfileBinding;


public class NormalAccount extends Fragment {
    FragmentNormalAccountBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentNormalAccountBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                viewModel.setProfessional(false);
